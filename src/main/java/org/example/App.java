...
public class App 
{
    public static void main( String[] args )
    {
        ...
        //service.editSouvenirsPrice("tarilka","ABRAMS", 324.6);             // змінити ціну сувеніра за його ім'ям та іменем його виробника
        //service.editProducersCountry("BREADLY", "USA");                   // змінити країну виробника за його ім'ям
        //service.editProducersName("BREADLY", "LEOPARD");                  // змінити ім'я виробника
        //service.showAllSouvenirs();                                       // вивести усі сувеніри
        //service.showSouvenirByProducersName("BREADLY");                   // вивести усі сувеніри за ім'ям виробника
        ...
        //service.showAllSouvenirsByYear(2002);                             // вивести усі сувеніри за роком
        //service.showAllSouvenirsByCountry("USA");                         // вивести усі сувеніри за країною виробника
        //service.deleteProducer("GEPARD");                                 // видалити виробника та усі його сувеніри
    }
}
